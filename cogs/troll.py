...
class Troll(commands.Cog):
    ...
    async def gio5(self, ctx):
        return await ctx.send('https://cdn.discordapp.com/attachments/1187285011347558440/1199883526628196353/image.png?ex=65c4299d&is=65b1b49d&hm=823fdbc0d20b33e57c8fa8c729e8c2646888f74199cd6e8dc19ad02f66acfcb2&')

    @commands.command(aliases=["gank"])
    async def gio7(self, ctx):
        return await ctx.send('https://cdn.discordapp.com/attachments/812173836358254625/1199888180913127464/image.png?ex=65c42df3&is=65b1b8f3&hm=2f5abfb6e3c25861c6cfc67a966a61650fb592ec8a93a3f7179a8267a1b290d0&')
    
    @commands.command(aliases=["heishalfblackwithadhdsohecansaythis"])
    async def gio8(self, ctx):
        return await ctx.send('https://cdn.discordapp.com/attachments/1187285011347558440/1199890184955764777/image.png?ex=65c42fd0&is=65b1bad0&hm=1bfaefac122cac3b17fa39af102f08e4a997e32b9fceb32459478eb5045f80a0&')

    @commands.command(aliases=["bitch"])
    async def jay3(self, ctx):
        return await ctx.send('https://cdn.discordapp.com/attachments/1128963082484457472/1199890410668036196/image.png?ex=65c43006&is=65b1bb06&hm=d9314c275bd9b6b7833d2e7046c5f239f98312163b7612e4283617759832f1e1&')
