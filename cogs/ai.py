    ...
    async def on_message(self, message):
        ...
        if message.channel.id != slimecraft_id:
            ...
            async with message.channel.typing():
                try:
                    async with self.cai.client.connect(
                        "14b9f6566f4b4932ec80522e4ec99a77240ee717"
                    ) as chat2:
                    ...
                    logging.error(
                        f"CharacterAI Library is not working! {err}", "CharacterAi"
                    )
                    embed = discord.Embed()
                    ...
                    await message.channel.send(f"Filtered! :3")
                    return
            ...
            await message.channel.send(
                f"Go to {kamasutra.mention} to speak to me {message.author.mention} :)"
            )
