...
def template(*, message_type="", color_of_type=Fore.BLUE, content="", dependency="", args=""):
    now = datetime.now()
...
def system(system_info, dependency="", *args):
    template(message_type="SYSTEM  ", color_of_type=Fore.GREEN, content=system_info, dependency=dependency)
